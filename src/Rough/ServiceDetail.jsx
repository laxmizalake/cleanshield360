  ...
  return (
    <section className="service-detail-wrapper">
      ...
      <div className="service-detail-header">
        <h2>Our Services</h2>
        <p>
          CleanShield provides comprehensive facility solutions crafted with 
      ...
      <div className="service-detail-grid">
        ...
        <div className="sd-card">
          ...
          <Link to="/contact" className="sd-btn">Request Staff</Link>
        </div>
        ...
        <div className="sd-card">
          ...
          <Link to="/contact" className="sd-btn">Get Maintenance</Link>
        </div>
